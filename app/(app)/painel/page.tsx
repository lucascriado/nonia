...
import { Cake, CalendarDays, MapPin, PartyPopper, Settings, UserPlus, Users } from "lucide-react";
...
type DashboardData = {
  // `activeCells` continua vindo da API; a interface de células saiu e o
  // indicador foi com ela. O dado no banco fica intacto.
  stats: { totalMembers: number; visitorsThisMonth: number; birthdaysThisMonth: number };
...
const emptyData: DashboardData = { stats: { totalMembers: 0, visitorsThisMonth: 0, birthdaysThisMonth: 0 }, activities: [], birthdays: [], events: [] };
