...
const searchItems = [
  ...
  { title: "WhatsApp", description: "Conexão da igreja e envio em massa", href: "/whatsapp", icon: MessageCircle, keywords: "whatsapp zap mensagem envio massa disparo conectar qr conversa" },
